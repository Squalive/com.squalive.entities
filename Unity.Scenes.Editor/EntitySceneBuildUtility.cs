...
{
    public static class EntitySceneBuildUtility
    {
...
#pragma warning restore 649
        ...
        public static void BuildScenes( HashSet<Hash128> sceneHashes, Hash128 playerGuid, BuildTarget buildTarget, string buildFolder )
        {
            Directory.CreateDirectory( buildFolder );

            var array = sceneHashes.ToArray();
            
            var artifactKeys = new Dictionary<Hash128, ArtifactKey>();
            PrepareEntityBinaryArtifacts( playerGuid, sceneHashes, artifactKeys );
        ...
        {
            var newDir = Path.GetDirectoryName( dst );
